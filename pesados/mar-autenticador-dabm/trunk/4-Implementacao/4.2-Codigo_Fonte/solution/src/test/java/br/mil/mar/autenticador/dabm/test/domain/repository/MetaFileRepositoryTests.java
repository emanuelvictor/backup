 ...
 */
public class MetaFileRepositoryTests extends AbstractIntegrationTests
{
	/*-------------------------------------------------------------------
	 *				 		     ATTRIBUTES
	 *-------------------------------------------------------------------*/	
	...
	{
		final FileInputStream file = new FileInputStream(this.getClass().getResource("/example.pdf").getPath().replaceAll( "%20", " " ));
		...
		Assert.assertNotNull( metaFile.getPath().replaceAll( "%20", " " ) );
	}
	...
	public void removeByPath() throws RepositoryException, IOException, FileSizeLimitExceededException
	{
		...
		{
			this.metaFileRepository.removeByPath( metaFile.getPath().replaceAll( "%20", " " ) );
		}
	}
	...
	public void findByPath() throws RepositoryException, IOException, FileSizeLimitExceededException
	{
		...
		{
			MetaFile m = this.metaFileRepository.findByPath( metaFile.getPath().replaceAll( "%20", " " ), true );
			...
			Assert.assertNotNull( m.getPath().replaceAll( "%20", " " ) );
