...
<md-dialog md-theme="default" aria-label="Perfil de acesso" style="width: 600px">
    ...
    <md-dialog-content style="padding: 24px;float:left">
        ...
        <md-content>
            ...
            <md-chips id="user-reply" ng-model="usuarioSelecionado" md-autocomplete-snap md-require-match>
                <md-autocomplete
