(function(window, angular, undefined) {
  ...
  var module = angular.module('autenticador', ['ngMaterial', 'ui.router', 'eits-dwr-broker', 'eits-md',
    'eits.controls.dropdown', 'uploadImage', 'ui.tree', 'ngMessages', 'md.data.table', 'eits.search.tags']);
  ...
  module.config( function( $stateProvider, $urlRouterProvider, $importServiceProvider, $mdThemingProvider) {
    ...
    $stateProvider.state('inicio',{
      ...
      template : '<div flex layout="column" ui-view/>'
    }).state('inicio.admin',{
      url : "/admin",
   ...
   *
   */
  module.run( function( $mdToast, $rootScope, $window, $state, $stateParams, $mdSidenav ) {
    //Serviço do DWR para redirecionar para tela delogin caso perca a sessão
