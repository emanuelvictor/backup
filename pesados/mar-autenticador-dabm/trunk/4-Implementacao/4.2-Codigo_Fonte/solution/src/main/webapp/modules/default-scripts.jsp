...
<!-- Angular material -->
<script type="text/javascript" src="./webjars/angular-material/<spring:eval expression="@environment.getProperty('angular-material.version')"/>/angular-material.js"/></script>
<!-- <script src="https://material.angularjs.org/0.10.1-rc3/angular-material.min.js"></script> -->
...
<!--<script type="text/javascript" src="http://danielnagy.me/md-data-table/dependencies/md-data-table.min.js"></script>-->
<script type="text/javascript" src="./static/js/beta-components/md-data-table/md-data-table.js"></script>