...
public class Revisao<T extends IEntity<ID>, ID extends Serializable> implements Serializable
{
	/**
	 * 
	 */
	...
	/**
	 * data da {@link Revisao}
	 */
	@RevisionTimestamp
	private long timestamp;
	
	/**
	 * id do usuário da {@link Revisao}
	 */
	private Long userId;

	//---Metadata
	/**
	 * entidade da {@link Revisao}
	 */
	@Transient
	private T entity;
