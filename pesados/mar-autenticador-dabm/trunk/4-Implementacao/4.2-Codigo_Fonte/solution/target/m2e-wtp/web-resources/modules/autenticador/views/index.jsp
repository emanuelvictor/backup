...
<head ng-app="autenticador">
  ...
  <!-- Main -->
  <script type="text/javascript" src="./modules/autenticador/autenticador-module.js?v=1.0.6-RELEASE"></script>

  <!-- Controllers -->
  <script type="text/javascript" src="./modules/autenticador/controllers/home-controller.js?v=1.0.6-RELEASE"></script>
  <script type="text/javascript"
          src="./modules/autenticador/controllers/aplicativo-controller.js?v=1.0.6-RELEASE"></script>

  <!-- Usuario -->
  <script type="text/javascript"
          src="./modules/autenticador/controllers/usuario/usuario-controller.js?v=1.0.6-RELEASE"></script>
  <script type="text/javascript"
          src="./modules/autenticador/controllers/usuario/adicionar-aplicativos-controller.js?v=1.0.6-RELEASE"></script>
  <script type="text/javascript"
          src="./modules/autenticador/controllers/usuario/alterar-senha-controller.js?v=1.0.6-RELEASE"></script>
  <script type="text/javascript"
          src="./modules/autenticador/controllers/usuario/excluir-usuarios-controller.js?v=1.0.6-RELEASE"></script>
  <script type="text/javascript"
          src="./modules/autenticador/controllers/usuario/bloquear-usuarios-controller.js?v=1.0.6-RELEASE"></script>
  <script type="text/javascript"
          src="./modules/autenticador/controllers/usuario/replicar-perfis-controller.js?v=1.0.6-RELEASE"></script>


  <!-- Filters -->
  <script type="text/javascript" src="./modules/autenticador/filters/array-to-string.js?v=1.0.6-RELEASE"></script>
  <script type="text/javascript" src="./modules/autenticador/filters/format-date.js?v=1.0.6-RELEASE"></script>

  <!-- Directives -->
  <script type="text/javascript" src="./modules/autenticador/directives/same-as.js?v=1.0.6-RELEASE"></script>
  <script type="text/javascript" src="./modules/autenticador/directives/user-logged.js?v=1.0.6-RELEASE"></script>
