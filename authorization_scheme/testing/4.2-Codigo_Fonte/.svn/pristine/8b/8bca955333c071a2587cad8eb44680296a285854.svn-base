...
public class AplicativoService
{
	...
	public Aplicativo insertAplicativo( Aplicativo aplicativo )
	{
		...
		PerfilAcesso perfilAcesso = new PerfilAcesso(null, false , false, "Público","Perfil público",  aplicativo, null);
	...
	{
		System.out.println("puxando os aplicativos");
	...
	public void removePerfilAcesso( Long perfilAcessoId )
	{
		...
		this.perfilAcessoRepository.flush();
	}
