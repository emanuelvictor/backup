...
//		Assert.assertFalse( usuario.getPassword().equals( "usuario" ) );
	...
	public void changePasswordAndSendEmailMustPass() throws Exception
	{
		...
		Usuario usuario = this.usuarioService.findUsuarioById( 1L );
		Assert.assertNotEquals( this.passwordEncoder.encodePassword( "senha incorreta", saltSource.getSalt( usuario ) ), usuario.getSenha() );
	...
	public void bloquearAndDesbloquearUsuariosMustPass()
	{
		...
		this.usuarioService.bloquearUsuariosById( listIds, dataBloqueio, null );
		...
		this.usuarioService.desbloquearUsuariosById( listIds );
