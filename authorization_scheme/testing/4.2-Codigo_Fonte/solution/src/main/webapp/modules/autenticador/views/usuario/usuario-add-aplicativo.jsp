        ...
        <md-content style="max-height: 300px;">            
          <md-list>              
            <md-list-item class="md-2-line" ng-repeat="aplicativo in aplicativos">
                    ...
                    <div class="md-list-item-text">
                        <md-select placeholder="Selecione perfis" ng-model="model"  style="margin: -19px;width:100%"  md-on-open="getPerfisAplicativo(aplicativo.id)">
                            <md-select-label style="color: #888181;" >{{(perfisUsuario|arrayToString:aplicativo.id).length ? (perfisUsuario|arrayToString:aplicativo.id) : 'Selecione perfis'}}</md-select-label>
                            <md-progress-circular md-mode="indeterminate" ng-if="!perfisAplicativo.length>0" ></md-progress-circular>
