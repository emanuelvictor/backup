 ...
 */
@Service
public class TokenService implements AuthorizationServerTokenServices, ResourceServerTokenServices,
	...
	/// **
	// * Initialize these token services. If no random generator is set, one
	/// will be created.
	// */
