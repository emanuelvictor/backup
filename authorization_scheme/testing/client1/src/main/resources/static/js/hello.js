angular.module('hello', [ 'ngRoute' , 'ngCookies' ]).config([ '$routeProvider', '$httpProvider', function($routeProvider, $httpProvider) {
...
}]).controller('navigation', function($rootScope, $scope, $cookies, $http, $location, $route) {
