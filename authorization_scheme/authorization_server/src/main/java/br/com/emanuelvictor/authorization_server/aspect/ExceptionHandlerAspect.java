package br.com.emanuelvictor.authorization_server.aspect;
...
/**
 * Created by emanuelvictor on 16/04/15.
 */
@Aspect
        ...
        if (exception.getCause() instanceof ConstraintViolationException) {
            ...
            switch (cause.getSQLState()) {
                case "23503": // foreign_key_violation
                {
                    ...
                    throw new DataIntegrityViolationException("Nao foi possível realizar a opera��o pois este registro � referenciado em " + key + ".");// FIXME Localize
                }
